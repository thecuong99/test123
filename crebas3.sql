...
/* Created on:     1/29/2018 4:48:02 AM                         */
/*==============================================================*/
...
create table BOMON (
   ...
   TENBM                char(10)             not null,
   TRUONGBM             char(10)             null,
   constraint PK_BOMON primary key nonclustered (MABM, TENBM)
)
go
...
alter table GIAOVIEN
   add constraint FK_GIAOVIEN_THUOC_BOMON foreign key (MABM, TENBM)
      references BOMON (MABM, TENBM)
go
